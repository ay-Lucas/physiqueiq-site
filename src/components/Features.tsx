...
const features = [
  {
    ...
    description:
      "Capture consistent front and side shots with simple prompts that keep every check-in usable.",
    icon: Camera,
  },
  {
        ...
        <div className="max-w-3xl lg:text-start">
          ...
          <Reveal variant="fade" delay={200}>
            <p className="mt-6 text-lg text-gray-300">
              PhysiqueIQ keeps the workflow simple: capture, review, and
              understand. Every part of the app is built to make progress easier
              to measure at a glance.
            </p>
          </Reveal>
        </div>
